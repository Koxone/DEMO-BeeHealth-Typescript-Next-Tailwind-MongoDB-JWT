...
export default function PrivacyViewRoute() {
  ...
  return (
    <div>
      ...
      <div className="mx-auto max-w-4xl px-4 py-16 sm:px-6 lg:px-8">
        <h1 className="mb-6 text-4xl font-bold text-gray-700">Política de Privacidad</h1>
        <div className="bg-beehealth-body-main space-y-6 rounded-xl p-8 shadow-md">
          <section>
            <h2 className="mb-3 text-2xl font-semibold text-gray-700">Recopilación de Datos</h2>
          ...
          <section>
            <h2 className="mb-3 text-2xl font-semibold text-gray-700">Uso de la Información</h2>
            <p className="text-gray-600">
          ...
          <section>
            <h2 className="mb-3 text-2xl font-semibold text-gray-700">Seguridad</h2>
            <p className="text-gray-600">
          ...
          <section>
            <h2 className="mb-3 text-2xl font-semibold text-gray-700">Tus Derechos</h2>
            <p className="text-gray-600">
