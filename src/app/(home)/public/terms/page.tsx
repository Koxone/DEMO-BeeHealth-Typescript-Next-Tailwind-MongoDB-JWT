...
export default function TermsViewRoute() {
  ...
  return (
    <div>
      ...
      <div className="mx-auto max-w-4xl px-4 py-16 sm:px-6 lg:px-8">
        <h1 className="mb-6 text-4xl font-bold text-gray-700">Términos y Condiciones</h1>
        <div className="bg-beehealth-body-main space-y-6 rounded-xl p-8 shadow-md">
          <section>
            <h2 className="mb-3 text-2xl font-semibold text-gray-700">1. Aceptación de Términos</h2>
            <p className="text-gray-600">
              Al acceder y utilizar BeeHealth, aceptas estar sujeto a estos términos y condiciones.
            </p>
          </section>
          <section>
            <h2 className="mb-3 text-2xl font-semibold text-gray-700">2. Uso del Servicio</h2>
            <p className="text-gray-600">
          ...
          <section>
            <h2 className="mb-3 text-2xl font-semibold text-gray-700">3. Privacidad</h2>
            <p className="text-gray-600">
          ...
          <section>
            <h2 className="mb-3 text-2xl font-semibold text-gray-700">4. Responsabilidades</h2>
            <p className="text-gray-600">
