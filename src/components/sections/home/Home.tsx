...
// Custom Hooks
import { useGetTotalWeightLost } from '@/@hooks/users/useGetTotalWeightLost';
...
export default function Home() {
  ...
  // Total Weight Lost
  const { totalLost, loading: totalLostLoading } = useGetTotalWeightLost();
      ...
      <section className="mx-auto max-w-7xl px-4 py-10 sm:px-6 lg:px-8">
        <div className="grid items-center gap-8 md:grid-cols-2 md:gap-12">
          ...
          <div className="mx-auto w-full max-w-md">
            <GlobalWeightLoss totalLost={totalLost} loading={totalLostLoading} />
          </div>
        </div>
      </section>
