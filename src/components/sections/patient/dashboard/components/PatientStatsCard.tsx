...
export default function PatientStatsCard({
  ...
  const styles = {
    ...
    appointment:
      'border border-gray-200 bg-beehealth-green-secondary-dark text-white hover:border-beehealth-green-primary-light active:scale-95',
  };
  ...
  const iconColors = {
    ...
    appointment: 'text-white animate-bounce',
  };
    ...
    >
      ...
      <div className="mb-2 flex items-center justify-between">
        <div className="flex w-full items-center justify-between">
          ...
          {count && (
            <button className="bg-beehealth-red-primary-solid hover:bg-beehealth-red-primary-solid-hover rounded-lg px-1 py-2 text-xs font-medium text-white transition active:scale-95 md:px-4">
              Agendar Cita
            </button>
          )}
        </div>
