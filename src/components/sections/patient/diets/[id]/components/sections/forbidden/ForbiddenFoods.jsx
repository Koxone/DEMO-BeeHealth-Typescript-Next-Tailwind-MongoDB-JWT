...
export default function ForbiddenFoods({ diet }) {
  const items = diet.forbiddenFoods.items || [];
  const note = diet.forbiddenFoods.note || '';
  ...
  return (
    <section className="bg-beehealth-body-main rounded-xl border border-gray-200 p-6 shadow-sm md:p-4">
      ...
      <div className="mb-4 flex items-center gap-3">
        ...
        <h2 className="text-xl font-semibold text-gray-700">Alimentos Prohibidos</h2>
      </div>
