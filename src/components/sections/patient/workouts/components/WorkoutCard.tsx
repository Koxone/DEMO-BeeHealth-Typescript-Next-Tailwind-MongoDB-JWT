    ...
    >
      ...
      <div className="relative h-48 overflow-hidden bg-gray-100">
        ...
        <div className="absolute top-3 right-3">
          <span
            className={`bg-beehealth-body-main/80 rounded-full px-2 py-1 text-xs font-medium shadow-sm backdrop-blur-sm ${getNivelColor(workout?.workout?.difficulty)}`}
          >
      ...
      <div className="p-4">
        ...
        <div className="flex items-center gap-2 text-sm text-gray-600">
          ...
          <span>{workout?.workout?.duration} minutos</span>
        </div>
