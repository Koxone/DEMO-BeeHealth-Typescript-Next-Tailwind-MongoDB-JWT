...
// Custom Hooks
import { useVercelBlobUpload } from '@/presentation/hooks/shared/';

function ImagesSection({ images, setImages }) {
  // Vercel Blob Upload Custom Hook
  const { uploadFile, loading: uploadLoading, error: uploadError } = useVercelBlobUpload();
  ...
  return (
    <section className="bg-beehealth-body-main rounded-xl border border-gray-200 p-6 shadow-sm md:p-8">
      ...
      <div className="space-y-4">
        ...
        {uploadLoading && <p className="text-sm text-gray-500">Subiendo imagen...</p>}
