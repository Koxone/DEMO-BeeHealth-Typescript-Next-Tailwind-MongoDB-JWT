...
// Constants, Services and Mappers
...
import { workoutGetDifficultyColor } from '@/presentation/services/workout/workoutGetDifficultyColor';
...
function BasicInfoSection({ form, setForm }: BasicInfoSectionProps) {
  return (
        ...
        <div className="space-y-2">
          ...
          <div className="relative">
            <select
              ...
              className={`w-full appearance-none rounded-xl border-2 px-4 py-3.5 font-semibold shadow-sm transition-all duration-300 focus:shadow-md focus:outline-none ${workoutGetDifficultyColor(form.difficulty)}`}
            >
