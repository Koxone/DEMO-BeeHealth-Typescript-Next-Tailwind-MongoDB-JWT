...
function Date({ question, required, value, id, onChange, readOnly = false }) {
    ...
    <div className="mb-6">
      ...
      <div className="flex flex-wrap gap-2 sm:flex-nowrap sm:gap-2">
        ...
        <input
          ...
          placeholder="Día"
          className="w-18 shrink-0 rounded-lg border border-gray-300 px-3 py-3 text-center text-base sm:w-16 sm:py-2 md:py-3"
        />
        ...
        <div className="relative min-w-0 flex-1 sm:flex-initial">
          ...
          {monthDropdownOpen && (
            <>
              ...
              <div className="absolute top-full left-0 z-50 mt-1 max-h-48 w-full min-w-30 overflow-y-auto rounded-lg border border-gray-200 bg-white shadow-lg">
                {MONTHS.map((m) => (
                  <button
                    key={m.value}
                    type="button"
