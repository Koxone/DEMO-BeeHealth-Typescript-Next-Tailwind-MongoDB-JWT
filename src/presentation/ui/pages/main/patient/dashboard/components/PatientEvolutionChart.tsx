...
export default function PatientEvolutionChart({
  ...
  if (!weightLogs || weightLogs.length === 0) {
    return (
      <div className="bg-beehealth-body-main h-100 rounded-xl border border-gray-200 p-4 shadow-sm md:p-6">
  ...
  return (
    <div className="bg-beehealth-body-main h-100 overflow-hidden rounded-xl border border-gray-200 p-4 shadow-sm md:p-6">
      {/* Header */}
