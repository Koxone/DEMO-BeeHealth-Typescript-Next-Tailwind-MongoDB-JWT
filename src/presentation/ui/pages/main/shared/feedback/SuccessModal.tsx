...
export default function SuccessModal({ title, message }: SuccessModalProps) {
  return (
    <div className="fixed inset-0 z-50 flex h-screen items-center justify-center bg-black/50 p-4">
      <div className="animate-slideDown bg-beehealth-body-main relative w-full max-w-lg rounded-3xl border-2 border-green-500 p-8 shadow-2xl">
        {/* Close button */}
        <button className="absolute top-4 right-4 rounded-full p-2 text-gray-400 transition-colors hover:bg-gray-100 hover:text-gray-600">
          <X className="h-6 w-6" />
        </button>
