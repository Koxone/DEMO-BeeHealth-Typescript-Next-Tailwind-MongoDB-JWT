...
export default function Header({ currentUser }) {
  ...
  const fullName =
    ((currentUser?.name || '') + ' ' + (currentUser?.lastName || '')).trim() || 'Usuario';
  ...
  return (
    <header className="bg-beehealth-body-main top-0 z-40 border-b-2 border-gray-200 shadow-lg backdrop-blur-lg">
      {/* Desktop header */}
