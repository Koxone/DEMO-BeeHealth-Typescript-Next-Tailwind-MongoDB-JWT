...
export default function Sidebar({ role, specialty }) {
  ...
  return (
    <aside className="hidden h-full min-h-screen w-72 flex-col border-r-2 border-gray-200 shadow-xl md:flex">
        ...
        {sidebarOptions.map((item, index) => {
          ...
          return (
            <button
              ...
              className={`group animate-fadeInLeft relative flex w-full cursor-pointer items-center justify-between gap-3 overflow-hidden rounded-xl px-4 py-3.5 ${
                isActive
